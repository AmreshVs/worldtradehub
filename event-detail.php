<?php
  ...
  $url = urlencode("https://worldtradehub.in/event-detail?id=".$id);
...
<a id="whatsapp" class="whatsapp-icon" href="https://api.whatsapp.com/send?text=<?php echo $url; ?>" target="_blank">
